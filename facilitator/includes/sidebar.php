  ...
  <div class="sidebar">
    ...
    <nav class="mt-2">
      ...
      <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
        ...
        <li class="nav-item dropdown">
          <a href="../../napd_osms/facilitator/uploadLecture/index.php" class="nav-link nav-course">
        ...
        <li class="nav-item dropdown">
          <a href="../../napd_osms/facilitator/video/video_insert.php" class="nav-link nav-course">
