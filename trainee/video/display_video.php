...
<head>
  <meta charset="utf-8">
  <title>Session's Video Display</title>
  ...
  <ul>
    ...
    ?>
      <li>
        ...
        <video src="../../admin/uploads/video/<?php echo $info['video']; ?>" width="380px" poster="../../admin/uploads/thumbnail/<?php echo $info['thumbnail']; ?>" controls>
        </video>
      </li>
